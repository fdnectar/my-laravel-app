...
@section('content')
    ...
    <form action="{{ route('admin.store-client') }}" method="POST" id="addClientForm">
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="client_phone" name="client_phone" placeholder="Enter Client Phone"
                                    value="">
